    ...
    return PagedPlugin = (function(_super) {
      ...
      PagedPlugin.prototype.extendTemplateData = function(opts) {
        ...
        templateData.getPageCollection = function(collectionName, start, finish) {
          var collection, subCollection, _ref1, _ref2;
          if (collectionName == null) {
            collectionName = 'html';
          }
          collection = this.getCollection(collectionName);
          if (start == null) {
            start = ((_ref1 = this.document.page) != null ? _ref1.startIdx : void 0) || 0;
          }
          if (finish == null) {
            finish = ((_ref2 = this.document.page) != null ? _ref2.endIdx : void 0) || collection.models.length;
          }
        ...
        sourcePageDocuments.forEach(function(document) {
          return tasks.addGroup(function(addGroup, addTask) {
            ...
            // if (numberOfPages > 1) {
              return (function() {
                _results = [];
                for (var _i = 0; 0 <= numberOfPages ? _i < numberOfPages : _i > numberOfPages; 0 <= numberOfPages ? _i++ : _i--){ _results.push(_i); }
                return _results;
                ...
                return addTask(function(complete) {
                  ...
                  pageFilename = "" + basename + "-" + (pageNumber+1) + "." + extension;
                  // pageOutFilename = "" + outBasename + "." + pageNumber + "." + outExtension;
                  pageOutFilename = "" + outBasename + "/" + (pageNumber+1) + "/index." + outExtension;
                  pageRelativePath = relativePath.replace(filename, pageFilename);
                  docpad.log('info', "Creating page " + (pageNumber+1) + " for " + filePath + " at " + pageRelativePath);
